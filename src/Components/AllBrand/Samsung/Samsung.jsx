...
const Samsung = ({item}) => {
    ...
    <div class="px-5 pb-2">
        ...
        <div class="flex items-center justify-between py-4">
            <span class="text-lg font-bold text-gray-900 ">{item.price} BDT</span>
            <button onClick={handleCart} class="text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center ">Add to cart</button>
        </div>
    </div>
</div>
    );
